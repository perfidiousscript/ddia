export default function Explaination() {
  ...
  const moveRead = [
      { transform: "translate(5.6em, 13.4em)" },
  ];
  ...
  function moveRequest(){
    ...
    let nullResp = document.querySelector(".nullResp")
    ...
    setTimeout(()=>{
      nullResp.animate(increaseOpacity,opacityTiming)
    }, 6200)

    setTimeout(()=>{
      nullResp.animate(moveNullResp,requestTiming)
    }, 6300)
  }
